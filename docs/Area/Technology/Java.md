...
# Java Core
- [Tự học lập trình Java Core - Java SE - STACKJAVA](https://stackjava.com/java-core)
...
- [Login tài khoản sa và Config port 1433 cho SQL Server - YouTube](https://www.youtube.com/watch?v=QYv_whmaS7Y&list=PLpwmCwTvwxMEV0ScloeXYyNUgSPrTtszE)
- [classroom.rar - Google Drive](https://drive.google.com/file/d/1hSOI_gkghD2YdFaXSFPH3-J_qFdRF24f/view)
###  Spring 
- [Spring Boot (loda.me)](https://loda.me/courses/spring-boot)
- [Spring Boot Complete Tutorial - Master Class - YouTube](https://www.youtube.com/watch?v=zvR-Oif_nxg&t=74s)
